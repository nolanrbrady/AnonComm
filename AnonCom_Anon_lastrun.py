...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/nolanbrady/Desktop/LabResearch/IndependentStudy/AnonComm/AnonCom_Anon_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Our goal with this study is to better understand the ways in which people communicate. For this experiment you will be talking with someone through an anonymous chat room. We will provide a series of questions for you to discuss together. During your discussion please do not share any personal information such as age, gender, ethnicity, etc. You will be given one minute to discuss the prompt with the other person. If you happen to finish before then you can press spacebar. If you hear three tones that means you\'ve reached the end of the prompt and the experiment is moving forward.\n\nIf at any point you have any questions you are always welcome to ask your proctor.\n\nTo move on please press the "spacebar"',
    font='Open Sans',
...
text_20 = visual.TextStim(win=win, name='text_20',
    text="Before we start the experiment we are going to ask you describe a couple of things. You will have one minute to type your response on your phone. There is no need to send this to anyone.\n\nYou will have 60 seconds to write your response, but if you finish early please press spacebar.\n\nOnce you're ready to start please press spacebar.",
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
